...
from hardware_services.inventory_service import InventoryServiceProxy
from hardware_services.network_service import NetworkServiceProxy
...
class Quads(object):
    ...
    def __init__(self, config, statedir, movecommand, datearg, syncstate, initialize, force, hardwareservice, hardwareserviceurl):
        ...
        self.inventory_service = InventoryServiceProxy(hardwareservice, hardwarewserviceurl)
        self.network_service = NetworkServiceProxy(hardwareservice, hardwareserviceurl)
